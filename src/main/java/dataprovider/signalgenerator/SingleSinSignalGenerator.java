...
public class SingleSinSignalGenerator extends AbstractSignalGenerator {

    public SingleSinSignalGenerator(int samplingFrequency, double frameDuration) {
        this.samplingFrequency = samplingFrequency;
        this.frameDuration = frameDuration;
    }

    public SingleSinSignalGenerator() {
        this(44100, 0.02);
    }
    ...
    public String generateRandomSignal() {
        ...
        for (int i = 0; i < signalSize; i++) {
            ...
            double signalValue = Math.sin(2 * Math.PI * currentTime * toneFrequency);
