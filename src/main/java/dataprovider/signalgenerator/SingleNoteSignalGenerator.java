...
public class SingleNoteSignalGenerator extends SingleSinSignalGenerator {

    public SingleNoteSignalGenerator(int samplingFrequency, double frameDuration) {
        this.samplingFrequency = samplingFrequency;
        this.frameDuration = frameDuration;
    }

    public SingleNoteSignalGenerator() {
        this(44100, 0.02);
    }
